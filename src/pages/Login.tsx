      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-zinc-200">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-zinc-700 mb-1">Kullanıcı Adı veya E-posta</label>
              <input
                type="text"
                required
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link to="/sifremi-unuttum" className="font-medium text-indigo-600 hover:text-indigo-500">
                Şifremi unuttum
              </Link>
            </div>
          </div>
        ...
        <div className="text-center text-sm text-zinc-600">
          Hesabınız yok mu?{' '}
          <Link to="/kayit" className="font-medium text-indigo-600 hover:text-indigo-500">
            Kayıt Ol
          </Link>
        </div>
      </div>
