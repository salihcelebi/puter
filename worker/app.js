/*
█████████████████████████████████████████████
1) BU DOSYA, FİYAT TAKİP SAYFASININ TARAYICI TARAFINDAKİ ANA İŞLEM KODUDUR.
2) WORKER_BASE_URL DEĞERİNE BAĞLANARAK FİYAT VERİSİNİ UZAK WORKER'DAN ÇEKER.
3) allRows DİZİSİ, TABLOYA BASILACAK TÜM FİYAT KAYITLARINI GEÇİCİ OLARAK TUTAR.
4) els NESNESİ, SAYFADAKİ TÜM ÖNEMLİ DOM ELEMANLARINI TEK MERKEZDE TOPLAYARAK KODU SADELEŞTİRİR.
5) log() FONKSİYONU, ZAMAN DAMGALI İŞLEM GÜNLÜĞÜNÜ logBox İÇİNE YAZAR.
6) money() VE escapeHtml() FONKSİYONLARI, TABLO ÇIKTISINI HEM OKUNUR HEM GÜVENLİ HALE GETİRİR.
7) uniqueValues() VE fillSelect() FONKSİYONLARI, SAĞLAYICI VE SERVİS FİLTRELERİNİ DİNAMİK OLARAK DOLDURUR.
8) getFilteredRows(), ARAMA KELİMESİNE VE SEÇİLEN FİLTRELERE GÖRE SATIRLARI DARALTIR.
9) renderTable(), FİLTRELENMİŞ SONUÇLARI HTML TABLO GÖRÜNÜMÜNE DÖNÜŞTÜRÜR VE KAYIT SAYISINI GÜNCELLER.
10) buildExcelRows() VE exportFilteredRowsToExcel(), GÖRÜNEN SATIRLARI XLSX KÜTÜPHANESİYLE EXCEL DOSYASI OLARAK DIŞA AKTARIR.
11) loadPrices(), GET /api/prices ÇAĞRISIYLA GÜNCEL FİYAT SNAPSHOT'INI ÇEKER.
12) runRefresh(), x-admin-secret HEADER'I İLE POST /api/refresh ÇAĞIRIP MANUEL YENİLEME YAPAR.
13) DOSYA, INPUT / SELECT / BUTTON EVENTLERİNİ DOM ÜZERİNDE DOĞRUDAN BAĞLAYAN KLASİK VANILLA JS YAPISI KULLANIR.
14) KISACA: BU DOSYA, FİYAT TABLOSUNU YÜKLEYEN, FİLTRELEYEN, YENİLEYEN VE EXCEL'E AKTARAN TARAYICI MOTORUDUR.
█████████████████████████████████████████████
*/
