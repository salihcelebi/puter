...
/*
█████████████████████████████████████████████
1) BU DOSYA, ADINDAN DA ANLAŞILDIĞI GİBİ İŞ DURUMU VEYA JOB STATUS ODAKLI AYRI BİR WORKER KATMANIDIR.
2) ANA AMACI, UZUN SÜREN AI İŞLERİNİN DURUMUNU AYRI BİR UÇ NOKTADAN SUNMAK OLARAK TASARLANMIŞ GÖRÜNÜR.
3) BU AYRIM, ÜRETİM İSTEĞİYLE DURUM SORGUSUNUN AYNI DOSYADA KARIŞMAMASINI SAĞLAR.
4) FRONTEND TARAFINDAKİ JOB TAKİBİ AKIŞLARI BU TÜR BİR DOSYAYA BAĞLANARAK SONUÇLARI AYRI SORGULAR.
5) DOSYA KISA OLSA DA MİMARİ ROLÜ ÖNEMLİDİR; ÇÜNKÜ ASENKRON İŞ TAKİBİNİ TEK YERDE TOPLAR.
6) BÖYLE BİR DOSYA, queued, processing, completed, failed GİBİ DURUM MANTIĞINI TAŞIMAYA ELVERİŞLİDİR.
7) ÜRETİM WORKER'LARINDAN AYRI OLMASI, STATUS SORGUSUNU DAHA HAFİF VE GÜVENLİ TUTAR.
8) ADI TÜRKÇE OLDUĞU İÇİN PROJENİN İÇ ADLANDIRMA DİLİYLE UYUMLU BİR DOSYADIR.
9) DOSYA, GÖRSEL / VIDEO / TTS GİBİ İŞLERİN “SONUÇ HAZIR MI?” KONTROL KAPISI GİBİ DÜŞÜNÜLEBİLİR.
10) KISACA: BU DOSYA, ASENKRON AI İŞLERİNİN DURUM TAKİBİNİ AYRI BİR WORKER OLARAK TAŞIMAK İÇİN VAR OLAN JOB-STATUS KATMANIDIR.
█████████████████████████████████████████████
*/
