...
/*
█████████████████████████████████████████████
1) BU DOSYA, VIDEO ÜRETİMİ İÇİN AYRILMIŞ AYRI BİR WORKER DOSYASIDIR.
2) CHAT VE IMAGE İŞLERİNDEN AYRI OLMASI, VIDEO AKIŞININ KENDİ PARAMETRELERİYLE YÖNETİLMESİNİ SAĞLAR.
3) VIDEO ÜRETİMİ GENELDE DAHA UZUN SÜREN VE DAHA MALİYETLİ BİR İŞ OLDUĞU İÇİN AYRI GATEWAY KULLANMAK DOĞRU BİR KARARDIR.
4) BU DOSYA, PROMPT, SÜRE, MODEL VE SAĞLAYICI GİBİ VIDEO ODAKLI PARAMETRELERİ NORMALLEŞTİRMEK İÇİN VARDIR.
5) İŞİN SONUCU GENELDE ANINDA DEĞİL JOB TABANLI GELDİĞİ İÇİN is-durumu.js İLE ÇİFTLİ ÇALIŞMAYA UYGUNDUR.
6) AYRI VIDEO WORKER KULLANMAK, HATA KODLARINI VE KOTA YÖNETİMİNİ DAHA KONTROLLÜ HALE GETİRİR.
7) FRONTEND TARAFINDAKİ /video SAYFASI BENZERİ EKRANLAR BU DOSYAYA BAĞLANARAK ÜRETİM BAŞLATIR.
8) DOSYA, UYGULAMANIN VIDEO ÜRETİM YETENEĞİNİ CHAT VE IMAGE KODUNDAN AYRI TUTAN TEMİZ BİR SINIR ÇİZER.
9) BÖYLECE GELECEKTE VIDEO SAĞLAYICISI VEYA MODELİ DEĞİŞSE BİLE ETKİ ALANI DAHA DAR OLUR.
10) KISACA: BU DOSYA, PROMPT'TAN VIDEO ÜRETİMİ BAŞLATAN VE BU AKIŞI AYRI BİR WORKER KATMANINDA TUTAN VIDEO GATEWAY'DIR.
█████████████████████████████████████████████
*/
